...
print("[INFO] Starting webcam... please show a fake face (photo or screen).")
time.sleep(2)
...
while True:
    ...
    cv2.imshow("Capture Fake Face Data", frame)
...
print(f"[INFO] Saved {count} fake face images in train/val/test folders.")
